        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" id=fbuatmatapelajaran action="{{ url('matapelajaran/buat') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" onclick="document.getElementById('fbuatmatapelajaran').submit()" class="btn btn-primary">
      ...
      <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" id=feditmatapelajaran action="{{ url('matapelajaran/edit') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-md-3 text-center">
                    Nama Mata Pelajaran
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" onclick="document.getElementById('feditmatapelajaran').submit()" class="btn btn-primary">
                <i class="fa fa-edit"></i> Edit
              </button>
            </div>
          </div>
    ...
    <div class="modal fade" id="modal-hapus">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" id=fhapusmatapelajaran action="{{ url('matapelajaran/hapus') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" onclick="document.getElementById('fhapusmatapelajaran').submit()" class="btn btn-primary">
                <i class="fa fa-trash"></i> Hapus
              </button>
            </div>
          </div>

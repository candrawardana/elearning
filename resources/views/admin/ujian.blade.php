              ...
              <div class="card-body table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $i }}.</td>
                      <td><a href="{{ url('ujiandetail/'.$k->id) }}" id="nameasli{{ $k->id }}">{{ $k->name }}</a></td>
                      ...
                      <td nowrap style=color:white>
                        ...
                        <a class="btn btn-primary" href="{{ url('soal/'.$k->id) }}">
                          <i class="fa fa-leaf"></i> Soal
                        </a>
                        <a class="btn btn-info" href="{{ url('ujiandetail/'.$k->id.'/buka') }}">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" id=fbuatujian action="{{ url('ujian/buat') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
      ...
      <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" id=feditujian action="{{ url('ujian/edit') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-md-3 text-center">
                    Nama Ujian
    ...
    <div class="modal fade" id="modal-hapus">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" id=fhapusujian action="{{ url('ujian/hapus') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">

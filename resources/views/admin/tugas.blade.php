              ...
              <div class="card-body table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $i }}.</td>
                      <td><a href="{{ url('tugasdetail/'.$k->id) }}" id="nameasli{{ $k->id }}">{{ $k->name }}</a></td>
                      ...
                      <td>
                        <a href="{{ url('tugas/download/'.$k->id.'/'.$k->file.'?download') }}">{{ $k->file }}</a>
                      </td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" id=fbuattugas action="{{ url('tugas/buat') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
      ...
      <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" id=fedittugas action="{{ url('tugas/edit') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-md-3 text-center">
                    Nama Tugas
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" onclick="document.getElementById('fedittugas').submit()" class="btn btn-primary">
                <i class="fa fa-edit"></i> Edit
              </button>
            </div>
          </div>
    ...
    <div class="modal fade" id="modal-hapus">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" id=fhapustugas action="{{ url('tugas/hapus') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="button" onclick="document.getElementById('fhapustugas').submit()" class="btn btn-primary">
                <i class="fa fa-trash"></i> Hapus
              </button>
            </div>
          </div>
